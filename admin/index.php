...
<head>
    ...
    <link rel="stylesheet" href="admin-nav.css?v=1">
    <link rel="stylesheet" href="export-ui.css?v=2">
</head>
    ...
    <main class="admin-shell">
        <header>
            <div>
                ...
                <h1>Registrations</h1>
                <p class="muted"><?= number_format($total) ?> total submissions</p>
            </div>
            <div class="header-actions"><a class="primary-link" href="matrimonial.php">Matrimonial registration</a>
        ...
        <nav class="admin-tabs" aria-label="Registration sections"><a class="active" href="index.php">Member registrations</a><a href="matrimonial-list.php">Matrimonial registrations</a></nav>
            ...
            <div class="table-wrap">
                <table>
                    ...
                    <tbody><?php if ($registrations === []): ?><tr>
                                <td colspan="12" class="empty">No registrations yet.</td>
                            </tr><?php endif; ?>
